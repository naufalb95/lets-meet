<template>
  <div v-on:click.stop class="flex justify-center items-center min-h-screen w-full my-28 mb-96">
    <form @submit.prevent="submitHandler" class="bg-white overflow-y-auto overflow-x-hidden shadow-md rounded px-12 py-12 w-1/2">
        ...
        <div class="w-full mb-4">
          <label id="description" class="text-center text-lg font-normal">Event Photo</label><br>
